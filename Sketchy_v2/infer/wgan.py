...
parser.add_argument("--output_dir", default='test_pic/middle_out', help="where to put output files")
parser.add_argument("--seed", type=int)
parser.add_argument("--checkpoint", default='gcl/train_middle',help="directory with checkpoint to resume training from or use for testing")
...
Model = collections.namedtuple("Model",
                               "outputs, predict_real, predict_fake, discrim_loss, discrim_grads_and_vars, gen_loss_GAN,gen_loss_tv,gen_loss_f gen_loss_L1, gen_grads_and_vars, train")
